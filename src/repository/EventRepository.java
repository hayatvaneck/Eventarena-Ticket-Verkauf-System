...
public class EventRepository {
    ...
    private void seedMockData() {
        ...
        Event concert = new Event(1L, "Don Toliver Octane Tour Leg 2", LocalDateTime.of(2026, 11, 02, 19, 0), 100.0, EventType.CONCERT);
        ...
        Event gala = new Event(2L, "Klassik Gala", LocalDateTime.of(2026, 12, 15, 20, 0), 150.0, EventType.GALA);
