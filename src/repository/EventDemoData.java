...
/**
 * Stellt die Demo-Events fuer den Erststart bereit.
 */
public final class EventDemoData {
    ...
    private static void add(List<Event> target, Long id, String title, String description, LocalDateTime dateTime, double basePrice, MapType mapType) {
        Event event = new Event(id, title, description, dateTime, basePrice, mapType);
